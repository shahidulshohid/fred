...
const QuotesSectionCustomer: FC = () => {
    ...
    return (
        <Container className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-6 lg:px-6 my-6 space-y-6">
            <PageHeader
                title="Your Quote is Ready!"
                subtitle="Here's the estimated cost for your electrical job."
                className="mb-6"
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                {/* Header */}
                <div className="px-4 sm:px-6 md:px-6 lg:px-6 py-4 sm:py-5 md:py-5 lg:py-5">
                ...
                {/* Content */}
                <div className="px-4 sm:px-6 md:px-6 lg:px-6 py-4 sm:py-5 md:py-5 lg:py-5 space-y-5">
                    {/* Job Description */}
                    <div>
                        <h3 className="text-sm text-[#5C5C5C] mb-2">Job Description</h3>
                        <p className="text-sm text-[#252525] font-semibold leading-relaxed">
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 sm:gap-0">
                        <span className="text-xl font-semibold text-[#252525]">Total Quote</span>
                        <span className="text-2xl font-semibold text-primary">£420</span>
                    </div>
            ...
            {/* What Happens Next Card */}
            <div className="bg-[#F9FAFB] rounded-xl border border-[#CFCFCF] p-4 sm:p-6 md:p-6 lg:p-6">
