...
export default function SignUpPage() {
  ...
  const [role, setRole] = useState<"Electrician" | "Customer">("Electrician");
      ...
      <div className="min-h-screen grid grid-cols-1 md:grid-cols-3 overflow-hidden">
        ...
        <div className="md:col-span-2 flex items-center justify-center px-6">
          <div className="max-w-[540px] lg:w-[540px] h-auto mx-auto bg-[#FFF] p-6 rounded-2xl border border-[#6E51E01A] shadow-[0_0_20px_0_rgba(94,95,224,0.1)]">
            ...
            <p className="text-lg font-semibold text-[#252525] mb-2">I’m a {role}</p>
            <div className="space-y-3 mb-6">
              <div className="grid grid-cols-2 gap-3">
                <button
                  onClick={() => setRole("Electrician")}
                  className={`cursor-pointer w-full border rounded-lg font-semibold text-sm py-2 flex flex-col items-center justify-center gap-1 ${role === "Electrician"
                    ? "border-[#DD3C3C] bg-[linear-gradient(180deg,#fcecec,#f5f3f3)] text-[#DC3C3C]"
                    : "text-[#636F85]"
                    }`}
                >
                  <Image
                    ...
                    width={20}
                    height={20}
                    className={`w-4 h-4 sm:w-5 sm:h-5 ${role === "Electrician" ? "brightness-0 saturate-100 invert-[25%] sepia-[85%] hue-rotate-[340deg]" : "brightness-0 saturate-100 invert-[45%] sepia-[10%]"
                      }`}
                    style={role === "Electrician" ? { filter: 'invert(25%) sepia(85%) saturate(5000%) hue-rotate(340deg) brightness(95%)' } : { filter: 'brightness(0) saturate(100%) invert(45%) sepia(10%) saturate(500%) hue-rotate(180deg) brightness(95%)' }}
                  />
                ...
                <button
                  ...
                  className={`cursor-pointer w-full border rounded-lg font-semibold text-sm py-2 flex flex-col items-center justify-center gap-1 ${role === "Customer"
                    ? "border-[#DD3C3C] bg-[linear-gradient(180deg,#fcecec,#f5f3f3)] text-[#DC3C3C]"
                    : "text-[#636F85]"
                    }`}
                >
                  <Image
                    src="/authImg/customer.svg"
                    alt="Customer icon"
                    width={20}
                    height={20}
                    className="w-4 h-4 sm:w-5 sm:h-5"
                    style={role === "Customer" ? { filter: 'invert(25%) sepia(85%) saturate(5000%) hue-rotate(340deg) brightness(95%)' } : { filter: 'brightness(0) saturate(100%) invert(45%) sepia(10%) saturate(500%) hue-rotate(180deg) brightness(95%)' }}
                  />
